...
Now you have your snapshots in binary files you can use it converting them through the following code.
...
The parameter specify the number of snapshots you want to convert.